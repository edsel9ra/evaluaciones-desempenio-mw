...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['role:evaluator'])->group(function () {
        ...
        Route::get('/reports', [ReportController::class, 'index'])->name('reports.evaluator');
        Route::get('/reports/individual', [ReportController::class, 'individual'])->name('reports.individual.evaluator');
        Route::get('/reports/trends', [ReportController::class, 'trends'])->name('reports.trends.evaluator');
    });

    Route::middleware(['role:employee'])->group(function () {
        Route::get('/my-evaluations', [EvaluationController::class, 'myEvaluations'])->name('my-evaluations');
        Route::get('/view-evaluations', [EvaluationController::class, 'index'])->name('view-evaluations.employee');
    });
